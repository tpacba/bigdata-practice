...
//
// Debug information:
// Generated date: Fri Feb 12 11:25:02 EST 2021
...
public class users extends SqoopRecord  implements DBWritable, Writable {
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.birthdate = JdbcWritableBridge.readDate(1, __dbResults);
    ...
    this.user_id = JdbcWritableBridge.readInteger(7, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeDate(birthdate, 1 + __off, 91, __dbStmt);
    ...
    JdbcWritableBridge.writeInteger(user_id, 7 + __off, 4, __dbStmt);
    return 7;
  }
  ...
  public void setField(String __fieldName, Object __fieldVal) {
    if ("birthdate".equals(__fieldName)) {
